...
call s:h('Error',         {'fg': s:red, 'cterm': s:bold, 'gui': s:bold})
call s:h('ErrorMsg',      {'fg': s:red})
call s:h('WarningMsg',    {'fg': s:yellow})
call s:h('MoreMsg',       {'fg': s:bg_subtle, 'cterm': s:bold, 'gui': s:bold})
call s:h('LineNr',        {'fg': s:bg_subtle})
call s:h('CursorLineNr',  {'fg': s:norm, 'bg': s:bg_subtle, 'cterm': s:bold, 'gui': s:bold})
...
call s:h('Folded',        {'fg': s:green, 'bg': s:bg, 'gui': s:italic, 'cterm': s:italic})
call s:h('FoldColumn',    {'fg': s:green, 'bg': s:bg, 'gui': s:italic, 'cterm': s:italic})
